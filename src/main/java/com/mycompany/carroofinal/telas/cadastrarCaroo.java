...
import com.mycompany.carroofinal.concerssionariacarroos.Dados;
...
public class cadastrarCaroo extends javax.swing.JFrame {
   ...
   // ControleCarro cCarro;
    ...
    private void initComponents() {
        ...
        campoMarca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Volkswagen", "Ford", "Chevrolet", "Fiat" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(campoAno, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(campoModelo, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(campoMarca, 0, 329, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        System.out.println(campoMarca.getSelectedItem());
        
        //limpar combobox botao modelo
        modelo = carro.getModelos(this.campoMarca.getSelectedItem().toString());
        List<String> parabox;
        parabox = modelo;
        this.campoModelo.setModel(new DefaultComboBoxModel(parabox.toArray()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        marca = this.campoMarca.getSelectedItem().toString();
        modelo = this.campoModelo.getSelectedItem().toString();
        ano = this.campoAno.getSelectedItem().toString();
        valor = Float.parseFloat(this.jTextField1.getText().trim().replace("R$",
                ""));
        
        carro.verificaValor(valor);
        if(carro.getErros().size()>0){
            for(int i=0; i<carro.getErros().size(); i++){
                JOptionPane.showMessageDialog(null,carro.getErros().get(i));
            }
        }
        else{
            carro.setAnoCarro(ano);
            carro.setMarcaCarro(marca);
            carro.setModeloCarro(modelo);
            carro.setValorCarro(valor);
            
            System.out.println(carro.getMarcaCarro());
            
            Carro carro = new Carro(marca, modelo, ano, valor);
            
            visualizarCarro vCarro = new visualizarCarro(this, carro);
            ...
            Gson gson = new Gson();
            String toJson = gson.toJson(Dados.carros);
            System.out.println("toJson = " + toJson);
        }
        
      /*  String marca = this.campoMarca.getSelectedItem().toString();
        String modelo = this.campoCargo.getSelectedItem().toString();
        String ano = this.campoLogin.getText();
        String valor = this.campoSenha.getText().trim();
        ...
        dispose();  
            ...
            Dados.carros.add(carro);
            Gson gson = new Gson();
            String toJson = gson.toJson(Dados.funcionarios);
            System.out.println("toJson = " + toJson);
